...
-- Contribution:  100%
-- ----------------------------------------------------------------------------
--  JSON-Driven Control Page with ButtonManager Integration
--
--  Purpose:
--  Blank control/info page using JSON configuration with a Back button.
-- ============================================================================
...
function OnInit()
    Log("Control Level Script Initialized (ButtonManager Version)")
    Log("Loading configuration from JSON file...")

    config = LoadJSON("assets/JSON/control_config.json")
    ...
    initialized = true
    Log("Control page initialization complete")
...
function OnDestroy()
    ...
    Log("Control page cleanup complete")
end
